...
//Publicas
LinkedList* ll_newLinkedList(void);                                 //OK
int ll_len(LinkedList* this);                                       //OK   //devuelve el valor del campo int size
...
int ll_clear(LinkedList* this);                                     //OK
int ll_deleteLinkedList(LinkedList* this);                          //OK
int ll_indexOf(LinkedList* this, void* pElement);
int ll_isEmpty(LinkedList* this);                                   //OK
